...
public class AddTokensConsole {
    ...
    public AddTokensConsole(JavaPlugin plugin) {
        this.plugin = plugin;
    ...
    public void addTokensAdminConsole(Player addingPlayer, int value) {
        ...
        Bukkit.getLogger().info("Dodano " + value + " Tokenów do konta gracza " + user);
