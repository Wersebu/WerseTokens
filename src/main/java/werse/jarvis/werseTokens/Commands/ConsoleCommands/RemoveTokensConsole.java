...
public class RemoveTokensConsole {
    ...
    public RemoveTokensConsole(JavaPlugin plugin) {
        this.plugin = plugin;
    ...
    public void removeTokensConsole(Player punishmentPlayer, int value) {
        ...
        Bukkit.getLogger().info("Odjęto " + value + " tokenów z konta gracza " + user);
